...
//            //3.审核图片  阿里云接口
            ...
            log.info("responseResult.getData() 类型: {}", responseResult.getData().getClass().getName());
            log.info("responseResult.getData() 值: {}", responseResult.getData());
...
//        BeanUtils.copyProperties(dto,wmNews);
        BeanUtils.copyProperties(wmNews, dto);// 拷贝时忽略 id 字段
        //文章的布局
        ...
        log.info("saveAppArticle - dto: {}", JSON.toJSONString(dto));
