...
public class WmNewsServiceImpl  extends ServiceImpl<WmNewsMapper, WmNews> implements WmNewsService {
    ...
    public ResponseResult submitNews(WmNewsDto dto) throws InvocationTargetException, IllegalAccessException {
        ...
        if(StringUtils.isBlank(wmNews.getTitle()) || StringUtils.isBlank(wmNews.getContent())){
            return ResponseResult.okResult(AppHttpCodeEnum.CONTENT_REFERENCE_FAIL);
        }
        ...
        //20260807修改-这里在调用方法前先“提交事务”，避免事务没提交获取不到id就调用后续方法
...
//                    wmNewsAutoScanService.autoScanWmNews(newsId);
                    wmNewsTaskService.addNewsToTask(newsId,wmNews.getPublishTime());
//                } catch (Exception e) {
